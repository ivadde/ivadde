return { -- Rename this file to configuration.lua for the bot to work.
    ...
    ['bot_token'] = '311910113:AAE_lKq2FO4hZM2yOj6-lqNtpOJGOtIEi7Y', -- In order for your bot to actually work, you MUST insert the Telegram bot API token you received from @BotFather.
